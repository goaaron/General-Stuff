...
void bsplit(pNode me, int n1, int n2, double *parm);
...
int partition(int nodenum, pNode splitnode, double *sumrisk, int n1, int n2, double *parm);

int print_tree(pNode me, int maxdepth);

SEXP rpart(SEXP ncat2, SEXP method2, SEXP opt2, SEXP parms2, SEXP ymat2, SEXP treat2,
...
SEXP xpred(SEXP ncat2, SEXP method2, SEXP opt2, SEXP parms2, SEXP xvals2,
	   SEXP xgrp2, SEXP ymat2, SEXP treat2, SEXP xmat2, SEXP wt2, SEXP ny2,
