...
extern int anovainit(int n, double *y[], double *treat, int maxcat, char **error,
...
extern void anovass(int n, double *y[], double *treat, double *value, double *risk,
		    double *wt, double max_y);
...
extern void anova(int n, double *y[], double *treat, double *x, int nclass,
